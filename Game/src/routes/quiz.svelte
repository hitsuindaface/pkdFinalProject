<script lang="ts">
    import {type Question, Questions, currentCat} from "./questionLib";
    ...
    let current: Question = next_question(Questions, currentCat, used_questions);
        ...
        if (is_right){
            ...
            if(used_questions.length !== Questions.length){
               ...
               /*  if(used_questions.length === Questions.length) {
                ...
                current = next_question(Questions, currentCat, used_questions);
...
{#if showModal}
    ...
    {:else}
        <div class = "backdrop">
            ...
            <div class = "exit">
                <button on:click = {()=>toggleModal()}>Exit to menu</button>
            </div>
